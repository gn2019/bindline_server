...
ESCORE_DIR = os.path.join(UPLOAD_DIR, SCORE)
...
PUBLIC_ESCORE_MATRIX = os.path.join(ESCORE_DIR, PUBLIC_DIR, ESCORE_MATRIX)
PUBLIC_ZSCORE_MATRIX = os.path.join(ESCORE_DIR, PUBLIC_DIR, ZSCORE_MATRIX)
PUBLIC_ISCORE_MATRIX = os.path.join(ESCORE_DIR, PUBLIC_DIR, ISCORE_MATRIX)
PUBLIC_ESCORE_RANK_MATRIX = os.path.join(ESCORE_DIR, PUBLIC_DIR, ESCORE_RANK_MATRIX)
